...
// -- 新增 start --
    if (!strIconFile.empty()) {
        if (!SystemExec("python %s %s '%s'", strIconPyFile.c_str(), strIconFile.c_str(), m_strAppFolder.c_str())) {
            ZLog::ErrorV(">>> replace_app_icon Failed!\n");
            return -1;
        }
    }
// -- 新增 end --
...
// -- 新增 start --
            ...
            if (!strIconFile.empty()) {
                if (jvInfoPlist.has("CFBundleIcons")) {
                    if (jvInfoPlist["CFBundleIcons"].has("CFBundlePrimaryIcon")) {
                        if (jvInfoPlist["CFBundleIcons"]["CFBundlePrimaryIcon"].has("CFBundleIconName")) {
                            jvInfoPlist["CFBundleIcons"]["CFBundlePrimaryIcon"].remove("CFBundleIconName");
                        }
                    }
                }
                if (jvInfoPlist.has("CFBundleIcons~ipad")) {
                    if (jvInfoPlist["CFBundleIcons~ipad"].has("CFBundlePrimaryIcon")) {
                        if (jvInfoPlist["CFBundleIcons~ipad"]["CFBundlePrimaryIcon"].has("CFBundleIconName")) {
                            jvInfoPlist["CFBundleIcons~ipad"]["CFBundlePrimaryIcon"].remove("CFBundleIconName");
                        }
                    }
                }
            }
