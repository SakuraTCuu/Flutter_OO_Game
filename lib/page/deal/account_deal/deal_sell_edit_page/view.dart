      ...
      children: <Widget>[
        Scaffold(
          ...
          appBar: AppBar(
            ...
            title: huoTitle(state.goodsId == null
                ? getText(name: 'textSellToAccount')
                : getText(name: 'textSellModify')),
          ),
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(
                            child: Text(getText(name: 'textSelectAccountNow'))),
                        GestureDetector(
                          onTap: () {
                            if (state.goodsId == null)
                              dispatch(
                  ...
                  Container(
                    ...
                    child: Text(
                      state.priceController.text.isEmpty
                          ? ""
                          : getText(name: 'textLowestServiceCharge', args: [
                              state.feeRate,
                              state.minFee,
                              state.obtainPtb ?? "x",
                              AppConfig.ptzName
                    ...
                    child: TextField(
                      ...
                      onChanged: (text) {
                        ...
                        if (null != text && text.length > 12) {
                          showToast(
                              getText(name: 'toastOnlyInputTwelveLetter'));
                        }
                      },
                    ),
                  ), //商品标题
