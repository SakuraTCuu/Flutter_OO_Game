...
Widget buildItem(int type, RebateCommitState state, Dispatch dispatch,
        ...
        typeView = DropdownButton(
          ...
          hint: new Text(
            state.curRole != null
                ...
                : getText(name: 'textSelectRoleName'),
            style: TextStyle(fontSize: 14, color: AppTheme.colors.textSubColor),
          ),
          onChanged: (String v) {
...
Widget buildInputItem(int type, RebateCommitState state, FocusNode focusNode,
    ViewService viewService) {
  bool isTop = false;
  double height = 55;
  String title = "";
