            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                        "${getText(name: 'textAccountColon')}${LoginControl.getUserName()}"),
//                    Text("平台币余额：${state.ptbCnt}"),
                    Text(
                        "${AppConfig.ptzName}${getText(name: 'textBalanceColon')}${state.ptbCnt}"),
                  ],
                ),
              ),
            ),
            ...
            SliverGrid.count(
              ...
              children: state.defaultMoneys
                  ...
                  .map((index) => GestureDetector(
                        ...
                        child: buildMoney(
                            state.defaultMoneys[index],
                            state.money == state.defaultMoneys[index],
                            viewService),
                      ))
                  .toList(),
            ),
