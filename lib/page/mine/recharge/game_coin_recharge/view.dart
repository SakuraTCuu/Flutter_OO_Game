...
//                                        UsNumberTextInputFormatter(),
                        ...
                        buildPayWayView(
                            state,
                            dispatch,
                            getText(name: 'textAliPayRe'),
                            "images/pic_n_zhifubao.png",
                            0),
                        buildPayWayView(
                            state,
                            dispatch,
                            getText(name: 'textWxPay'),
                            "images/pic_n_wechat.png",
                            1),
                        state.game != null
                            ? Container(
          ...
          ListView(
            ...
            children: <Widget>[
              buildItemView(
                  ...
                  viewService,
                  getText(name: 'textGameAccount'),
                  getText(name: 'textPleaseInputAccount'),
              ...
              buildItemView(
                  ...
                  dispatch,
                  viewService,
                  getText(name: 'textPassword'),
                  getText(name: 'textPleaseInputAccountPassword'),
                  state.pswController,
                  1),
              Container(
                height: 1,
              ...
              buildItemView(
                  ...
                  dispatch,
                  viewService,
                  getText(name: 'textServiceSimple'),
                  getText(name: 'textPleaseInputService'),
                  state.serverController,
                  1),
              Container(
                height: 1,
              ),
              buildItemView(
                  ...
                  dispatch,
                  viewService,
                  getText(name: 'textRoleName'),
                  getText(name: 'textPleaseInputRole'),
                  state.roleNameController,
                  1),
              Container(
                height: 1,
              ),
...
//                              WhitelistingTextInputFormatter(RegExp(r'\d+')),
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  getText(name: 'textPleaseInputRechargePrice'),
                              border: InputBorder.none,
                              hintStyle: TextStyle(
                                  color: AppTheme.colors.textSubColor,
                                  fontSize: 15),
              ...
              buildItemView(
                  ...
                  dispatch,
                  viewService,
                  getText(name: 'textRemark'),
                  getText(name: 'textPleaseInputRemark'),
                  state.remarkController,
                  1),
              Container(
                color: Colors.white,
