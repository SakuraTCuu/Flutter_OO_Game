...
Reducer<RegisterPageState> buildReducer() {
  return asReducer(
    <Object, Reducer<RegisterPageState>>{
      ...
      RegisterPageAction.setCheckState:_setCheckState,
    },
  );
}
...
RegisterPageState _setCheckState(RegisterPageState state, Action action) {
  RegisterPageState newState = state.clone();
