...
//  跳转页面
  ...
  static gotoWebView(int type,BuildContext ctx) {
    String url;
    String title;
    switch (type) {
      case 1:
      ...
      case 4:
        ...
        url = H5Url.url_privacy;
        break;
      case 5:
        title = getText(name:"textLogoutDescribeLeast");
        url = H5Url.url_logout_describe;
        break;
    }
    var pageName = WebPluginPage.pageName;
    if (Platform.isAndroid) {
    ...
    AppUtil.gotoPageByName(ctx, pageName,
